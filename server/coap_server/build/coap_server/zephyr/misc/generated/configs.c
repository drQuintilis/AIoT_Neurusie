...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_SERVER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COAP_SERVER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OT_COAP_UTILS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OT_COAP_UTILS_LOG_LEVEL, 3);
